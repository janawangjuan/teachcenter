<template>
  <div id="app" class="app">
    <div class="testpaperAnalysis-wrap">
      <el-container>
        <el-header>
          <iHeader></iHeader>
        </el-header>
        <el-main>
          <div class="testpaperAnalysis-content">
            <div class="title-wrap">
              <div class="title-left">当前位置：{{this.$route.params.className}}&gt;课表&gt;卷面分析</div>
              <div class="title-right">
                <a  :href="urlStr" download="教学中心" class="button-a">导出表格</a>
              </div>
            </div>
            <div v-if="examInfo">
              <div class="name-wrap">
                <span class="name-content">测评名称：{{examDetail.taskName}}</span>
                <span class="span1">题目数量：共{{examDetail.questionNum}}题</span>
                <span class="span1">测评时间：{{webApi.formatDate(examDetail.examenStartDate,'YMD')}}</span>
              </div>
