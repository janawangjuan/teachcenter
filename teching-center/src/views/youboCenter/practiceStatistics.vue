                ...
                <el-table
                  ...
                  <el-table-column
                    ...
                    <template slot-scope="scope">
                      第{{scope.row.studyPlanExtendIndex}}周({{webApi.formatDate(scope.row.startDate,'YMD')}}至{{webApi.formatDate(scope.row.endDate,'YMD')}})
                    </template>
                  </el-table-column>
                  <el-table-column
  ...
  export default {
    ...
    methods:{
      ...
      toTestpaper(params){  //去卷面分析页
        ...
        window.open('/#'+this.$route.path+'/youboTestpaperAnalysis/'+params.taskId,'_blank')
      ...
      toCompletion(params){  //去完成情况
        ...
        window.open('/#'+this.$route.path+'/youboCompletion/'+params.taskId,'_blank')
      },
      getEchartData(){
        this.xData = []
        this.ySeris = []
        this.legendData = []
        Request.ajax('getStatisticsCoursePaperByChart',{
          token:this.techLoginInfo.token,
          classId: this.$route.params.classId,
          courseId: this.classCourseInfo.courseId,
          courseTeachingType:'flipped',
      ...
      getRankData(params){
        this.rankList = ''
        Request.ajax('getStatisticsCoursePaperByLeader',{
          token:this.techLoginInfo.token,
          classId:this.$route.params.classId,
          courseId:this.classCourseInfo.courseId,
          courseTeachingType:'flipped',
      ...
      getExamenTaskList(){  //获取表格统计数据
        Request.ajax('getExamenTaskList',{
          token:this.techLoginInfo.token,
          classId:this.$route.params.classId,
          courseId:this.classCourseInfo.courseId,
          courseTeachingType:'flipped',
